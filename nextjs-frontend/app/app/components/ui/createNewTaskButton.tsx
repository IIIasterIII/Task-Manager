...
const CreateNewTaskButton = () => {
  ...
  return (
    <div onClick={handleCloseModal} className='w-full h-10 border flex flex-row items-center gap-5 rounded-2xl hover:bg-indigo-800 duration-500 cursor-pointer bg-indigo-900'>
