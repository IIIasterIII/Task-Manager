"use client"
import { toggleCreateProject } from "../features/ui/userSlice"
import Button from "./components/ui/buttons/button"
import { useAppDispatch } from "../lib/hook"

const Art = () => (
  <svg width="300px" height="300px" viewBox="0 0 1024 1024" className="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg">
    <path d="M352.7 103m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" fill="#FFEB4D" /><path d="M807.7 951h-449V192L643.8 87l163.9 105z" fill="#F7D4FF" />
    <path d="M643.7 951h-285V192l285-105z" fill="#FFE0B6" /><path d="M523.7 951.5h-314v-531l199-74 115 74z" fill="#DAE5FF" />
...
const Page = () => {
  ...
  return (
    <div className='h-screen relative flex flex-col overflow-y-scroll items-center p-5'>
      <div className="w-full h-full flex justify-center flex-col text-center items-center">
        <Art/>
        <h1 className="text-xl font-bold">Welcome to your Today view</h1>
        <p className="mt-2 mb-5">See everything due today across all your projects.</p>
        <Button title={"Add new project"} func={() => dispatch(toggleCreateProject(null))}/>
      </div>
    </div>
  )
}
